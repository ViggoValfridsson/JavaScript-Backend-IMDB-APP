...
const Home = () => {
  ...
  } = useFetch("https://api.themoviedb.org/3/trending/movie/week?api_key=f7f5e53209dd58bafcd025bff2a1e966");
  const {
    data: trendingTvData,
    isPending: trendingTvPending,
    error: trendingTvError,
  } = useFetch("https://api.themoviedb.org/3/trending/tv/week?api_key=f7f5e53209dd58bafcd025bff2a1e966");
  const {
    data: topMovieData,
  ...
  const {
    ...
    error: topTvError,
  } = useFetch("https://api.themoviedb.org/3/tv/top_rated?api_key=f7f5e53209dd58bafcd025bff2a1e966&page=1");
